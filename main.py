...
model_id = './models--runwayml--stable-diffusion-v1-5/snapshots/1d0c4ebf6ff58a5caecab40fa1406526bca4b5b9'
ldm_stable = StableDiffusionPipeline.from_pretrained(model_id, local_files_only=True).to(device)
...
def run_and_display(prompts, controller, latent=None, run_baseline=False, generator=None):
    if run_baseline:
        ...
        images, latent, real_img3 = run_and_display(prompts, EmptyControl(), latent=latent, run_baseline=False, generator=generator)
        print("with prompt-to-prompt")
        real_img3.save('google_result_3.png')
    ...
    real_img = ptp_utils.view_images(images)
